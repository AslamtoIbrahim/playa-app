            ...
            <DropdownMenuContent align="end" className="w-48 p-1">
                ...
                {invoice.status !== 'paid' && (
                    <div onClick={(e) => e.stopPropagation()}>
                         <AddPaymentDialog invoice={invoice} trigger={
                            <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="cursor-pointer gap-2 text-emerald-600">
                ...
                <div onClick={(e) => e.stopPropagation()}>
                    <DeleteInvoiceDialog 
                        ...
                        trigger={
                            <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="cursor-pointer gap-2 text-red-600 focus:bg-red-50 focus:text-red-700">
